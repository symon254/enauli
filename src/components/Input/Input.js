...
const mtInputOutlineColors = {
  ...
  purple: "mt-input-outline-indigo-300",
...
export default function Input({
  ...
  let container = ["w-full", "relative", "max-w-9xl", " mb-4"];
  ...
  return (
    <div className={container}>
      ...
      {success && (
        <span className="mt-1 block text-xs text-green-500">{success}</span>
      )}
    </div>
  );
}
